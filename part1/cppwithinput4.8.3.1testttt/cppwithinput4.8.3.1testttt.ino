...
int main(){
  ...
  */
  mearm.middleMiddle();
  delay(40);
  //cantino::cout << "middle value" << mearm.servoMiddle.read() << cantino::endl;
  ...
  mearm.backwardStance();
  delay(1000);
  mearm.servoLeft.write(50);
  cantino::cout << "servoleft written 50" << cantino::endl;
  delay(1000);
  mearm.servoLeft.write(120);
  cantino::cout << "servoleft written 120" << cantino::endl;
  //mearm.base();
  delay(1000);
  //mearm.middleTurn(83);
  */
